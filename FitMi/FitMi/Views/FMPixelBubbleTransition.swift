...
```
*/
open class FMPixelBubbleTransition: NSObject {
...
extension FMPixelBubbleTransition: UIViewControllerAnimatedTransitioning {
...
private extension FMPixelBubbleTransition {
